%[h, dxp, dyp, dzp] = scalarPSF(xp, z, nx, p) computes the scalar PSF model described by Gibson and Lanni
% The partial derivatives of the model relative to the source position xp are also calcualted.
...
function [h, dxp, dyp, dzp] = scalarPSF(xp, z, nx, p) %#ok<STOUT,INUSD>